...
//   const [resendEmil, sendResendEmail] = useState("");
...
//   const verifyUserByLink = async (linkToken: string) => {
//     setVerificationStatus(false);
//     setIsLoading(true);
//     try {
//       const res = await axiosInstance.get(
//         `/auth/verify-user?token=${linkToken}`
//       );
//       if (res.status >= 200 && res.status <= 204) {
//         setVerificationStatus(true);
//         sendResendEmail(res.data.email)
